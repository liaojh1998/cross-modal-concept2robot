...
def load_args():
    ...
    #### model specification
    parser.add_argument('--model_type', default='resnet18', type=str, choices=['resnet18', 'resnet50', 'virtex', 'swin-tiny', 'clip'], help='model to use for actor, critic, and master')
